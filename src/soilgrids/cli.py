...
@click.option(
    ...
    help=(
        ...
        " Values are based on the specified crs in a sequence of west, south, east,"
...
@click.option(
    ...
    help=(
        ...
        " Required when crs is set as a projection coordinate system. Default value"
        " set as 250 (m)"
    ),
)
@click.option(
...
@click.option(
    ...
    type=float,
    help=(
        "Width in pixels for data download. Required when crs is set as a geographic"
        " coordinate system."
    ),
)
@click.option(
    ...
    type=float,
    help=(
        "Height in pixels for data download. Required when crs is set as a geographic"
        " coordinate system."
    ),
)
@click.option(
